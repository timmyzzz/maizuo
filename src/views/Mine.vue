<template>
  <div class="app" :class="animateClass">
    <div class="top">
        <img @click="gotologin" :src="img" alt="">
        <div @click="gotologin" class="nickname">{{mobile}}</div>
    </div>
    <ul class="nav">
        <li>
...
export default {
    ...
    mounted(){
        if(localStorage.isLogin){
            ...
            this.img = "https://mall.s.maizuo.com/aec6406c7d3a3cb8520bdb165f42f977.jpg"
        }
    }
}
</script>
